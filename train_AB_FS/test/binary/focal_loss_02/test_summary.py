    ...
    for fold in folds:
        ...
        for csv_file in csv_files:
            ...
            with open(csv_file, "r") as f:
                  ...
                  auc = float(values[auc_index])
                  
            
            # Store the data in a structured format
            all_data.append({"fold": fold, "type": label, "F1": f1, "Precision": prec, "Recall": rec, "AUC": auc})
...
output_csv = f'{cont}_summary.csv'
